...
RigidelAlert.GameVersion = '2.052';
...
RigidelAlert.launch = function(){
  RigidelAlert.init = function(){
    ...
    // RigidelAlert.offIcon = [31,20,'img/icons.png'];
    RigidelAlert.onIcon = [0,0, 'https://raw.githubusercontent.com/Boonch342/MinorGraphicsCC/main/icon.png'];
    RigidelAlert.offIcon = [1,0, 'https://raw.githubusercontent.com/Boonch342/MinorGraphicsCC/main/icon.png'];
