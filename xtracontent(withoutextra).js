Game.registerMod("extraContent",{
    init:function(){
        ...
        this.createAchievements=function(){
            this.achievements = []
            this.achievements.push(new Game.Achievement("Plant based diet", "Sacrifice the garden <b>10</b> times. <q>Those hornets must be fat by now.</q>",[4,18,'https://orteil.dashnet.org/cookieclicker/img/gardenPlants.png']))
            this.achievements.push(new Game.Achievement("The will of the wizards", "Cast <b>9,999</b> spells. <q>Which wizard? Will.</q>",[24,11]))
        ...
        this.checkAchievements=function(){
            ...
            if(Game.Objects["Wizard tower"].minigameLoaded&&Game.Objects['Wizard tower'].minigame.spellsCastTotal>=9999)Game.Win("The will of the wizards")
            if(Game.Objects.Farm.minigameLoaded && Game.Objects.Farm.minigame.convertTimes >= 10)Game.Win("Plant based diet")
            let shiny = 1;
